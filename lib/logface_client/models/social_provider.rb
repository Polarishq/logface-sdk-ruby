...
module LogfaceClient
  ...
  class SocialProvider
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'authorize_url')
    ...
    def list_invalid_properties
      ...
      if @img_url.nil?
        invalid_properties.push("invalid value for 'img_url', img_url cannot be nil.")
      end
    ...
    def hash
      [authorize_url, display_name, id, img_url].hash
    end
